...
#define _MM_LOAD_INDEX_i64(op1, op2, op3)  vluxei64_v_i64m1(op1, op2, op3)

//#define _MM_LOAD_INDEX_i32 __builtin_epi_vload_indexed_2xi32
#define _MM_LOAD_INDEX_i32(op1, op2, op3) vluxei32_v_i32m1(op1, op2, op3)
...
#define _MM_REM_i64(op1, op2, op3) vrem_vv_i64m1(op1, op2)
...
#define _MM_MAX_i32(op1, op2, op3) vmax_vv_i32m1(op1, op2)
...
#define _MM_DIV_4xf32(op1, op2, op3)  vfdiv_vv_f32m2(op1, op2)
...
#define _MM_VFSGNJ_f64(op1, op2, op3) vfsgnj_vv_f64m1(op1, op2)

//#define _MM_VFSGNJ_f32      __builtin_epi_vfsgnj_2xf32
#define _MM_VFSGNJ_f32(op1, op2, op3) vfsgnj_vv_f32m1(op1, op2)
...
#define _MM_VFNCVT_F_F_f32(op1, op2) vfncvt_f_f_w_f32m1(op1)

//#define _MM_VFWCVT_F_X_f64  __builtin_epi_vfwcvt_f_x_2xf64_2xi32
#define _MM_VFWCVT_F_X_f64(op1, op2) vfwcvt_f_x_v_f64m2(op1)
...
#define _MM_VSLIDEDOWN_i64(op1, op2, op3) vslide1down_vx_i64m1(op1, op2, op3)
...
#define _MM_VSLIDEDOWN_f32(op1, op2, op3) vfslide1down_vf_f32m1(op1, op2, op3)

//#define _MM_VSLIDEDOWN_f64    __builtin_epi_vslidedown_1xf64
#define _MM_VSLIDEDOWN_f64(op1, op2, op3) vfslide1down_vf_f64m1(op1, op2, op3)
...
// reinterpert casts
#define _MMR_i32_to_f32(op1) vreinterpret_v_i32m1_f32m1(op1)
#define _MMR_f32_to_i32(op1) vreinterpret_v_f32m1_i32m1(op1)

#define _MMR_i32_to_u32(op1) vreinterpret_v_i32m1_u32m1(op1)
#define _MMR_u32_to_i32(op1) vreinterpret_v_u32m1_i32m1(op1)

#define _MMR_u32_to_f32(op1) vreinterpret_v_u32m1_f32m1(op1)
#define _MMR_f32_to_u32(op1) vreinterpret_v_f32m1_u32m1(op1)

#define _MMR_i64_to_f64(op1) vreinterpret_v_i64m1_f64m1(op1)
#define _MMR_f64_to_i64(op1) vreinterpret_v_f64m1_i64m1(op1)

#define _MMR_i64_to_u64(op1) vreinterpret_v_i64m1_u64m1(op1)
#define _MMR_u64_to_i64(op1) vreinterpret_v_u64m1_i64m1(op1)

#define _MMR_u64_to_f64(op1) vreinterpret_v_u64m1_f64m1(op1)
#define _MMR_f64_to_u64(op1) vreinterpret_v_f64m1_u64m1(op1)

#define _MMR_i32_to_i64(op1) vreinterpret_v_i32m1_i64m1(op1)
#define _MMR_i64_to_i32(op1) vreinterpret_v_i64m1_i32m1(op1)
